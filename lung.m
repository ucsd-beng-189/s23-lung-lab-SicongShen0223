...
title('mean alveolar O2 partial pressure v.s. altitude at beta =',num2str(beta));
xlabel('altitude'); ylabel('PA');

subplot(2,2,2);
plot(altitude,Pabar_vec,'-o');
title('mean arterial O2 partial pressure v.s. altitude at beta =',num2str(beta));
xlabel('altitude'); ylabel('Pa');

subplot(2,2,3);
plot(altitude,Pv_vec,'-o');
title('venous O2 partial pressure v.s. altitude at beta =',num2str(beta));
...
plot(altitude,Pabar_vec,'-o'); hold on;
plot(altitude,Pv_vec,'-o');
title('partial pressure v.s. altitude at beta =',num2str(beta));
...
title('mean alveolar O2 concentration v.s. altitude at beta =',num2str(beta));
xlabel('altitude'); ylabel('cA');

subplot(2,2,2);
plot(altitude,cabar_vec,'-o');
title('mean arterial O2 concentration v.s. altitude at beta =',num2str(beta));
xlabel('altitude'); ylabel('ca');

subplot(2,2,3);
plot(altitude,cv_vec,'-o');
title('venous O2 concentration v.s. altitude at beta =',num2str(beta));
...
plot(altitude,cabar_vec,'-o'); hold on;
plot(altitude,cv_vec,'-o');
title('concentration v.s. altitude at beta =',num2str(beta));
